        ...
        <>
            <div className="container text-white">
                ...
                <div className="row mx-1 mt-2 fs-4 about-us-body-text">
                    ...
                    <p>
                        If you want to conduct test, the process is very easy which is given below : <br />
                        <i class="fas fa-long-arrow-alt-right ms-5 me-3"></i>
                    ...
                    <p>
                        If you want to bear quiz you must have a student profile. You need to register your student profile <Link to="/app/new-user">here</Link>. <br />
                        <i class="fas fa-long-arrow-alt-right ms-5 me-3"></i>
